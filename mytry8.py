        ...
        if self.active:
            if keys[pygame.K_s]:
                ...
                if self.index_list_y + 1 < 20:
                    if pos_list[self.index_list_y + 1][self.index_list_x] == 0:
                        self.index_list_y += 1
                        self.y = 25 + (self.index_list_y + 3) * 30
                        self.rect = self.image.get_rect(center=(self.x, self.y))
                    else:
                        pos_list[self.index_list_y][self.index_list_x] = 1
                        print(pos_list)
                        self.active = False
                ...
                if self.index_list_x + 1 < 10:
                    if pos_list[self.index_list_y][self.index_list_x + 1] == 0:
                        self.index_list_x += 1
                        self.x = 25 + (self.index_list_x + 8) * 30
                        self.rect = self.image.get_rect(center=(self.x, self.y))
                self.down_active = True
            ...
            for member in g1:
                if member.active and member.down_active:
                    if member.index_list_y + 1 < 20:
                        if pos_list[member.index_list_y + 1][member.index_list_x] == 0:
